      ...
      <main className="max-w-3xl mx-auto px-6 py-16 space-y-10">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            <h3 className="font-medium text-sm text-foreground">Account credentials</h3>
          ...
          <div className="space-y-3">
            <h3 className="font-medium text-sm text-foreground">AI usage records</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="space-y-3">
            <h3 className="font-medium text-sm text-foreground">Provider API keys</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="space-y-3">
            <h3 className="font-medium text-sm text-foreground">Subscription tier</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground">Infrastructure and subprocessors</h2>
          <div className="rounded-xl border border-border overflow-hidden">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-border">
                ...
                <tr className="bg-background">
                  <td className="px-4 py-3 font-medium text-foreground">PayPal Giving Fund / Every.org</td>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-foreground">Emails we send</h2>
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            of usage and donation emails at any time from <strong className="text-foreground">Settings</strong> in your account,
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            at any time from <strong className="text-foreground">Settings</strong>, which removes your profile, usage records,
