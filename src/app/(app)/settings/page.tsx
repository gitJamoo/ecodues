...
export default async function SettingsPage() {
  ...
  const tabUsd = Number((profile as { pending_donation_usd?: number } | null)?.pending_donation_usd ?? 0);
  return (
    <div className="space-y-6 max-w-lg">
      ...
      <SettingsForm profile={profile} charities={charities} totalDamageUsd={totalDamageUsd} tabUsd={tabUsd} />
    </div>
  );
}
